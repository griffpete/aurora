      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-white/70 mb-6 md:mb-8">{description}</p>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-full shadow-lg"
            >
              {buttonText}
            </motion.button>
          </motion.div>
          ...
          >
            ...
            <div className="relative aspect-square max-w-[280px] md:max-w-md mx-auto">
              ...
              {/* Orbiting lights — hidden on small screens to avoid overflow */}
              {Array.from({ length: 8 }).map((_, i) => (
                <motion.div
                  key={i}
                  className="absolute w-3 h-3 md:w-4 md:h-4 rounded-full bg-white hidden sm:block"
                  style={{
                    top: "50%",
                    left: "50%",
                    marginLeft: "-8px",
